...
import GuildCategoryChart from '@/components/guild/GuildCategoryChart'
...
export default function ClientDashboardPage() {
  useAuthGuard()
  const { data, loading } = useGuildData()

  const totalGuild = data.length
